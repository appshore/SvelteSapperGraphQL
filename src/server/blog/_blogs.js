...
// This file is called `_blogs.js` rather than `blogs.js`, because
// we don't want to create an `/blog/blogs` route — the leading
// underscore tells Sapper not to do that.

const blogs = [
  {
    title: 'What is Sapeur?',
    slug: 'what-is-sapper',
    html: `
			<p>First, you have to know what <a href='https://svelte.technology'>Svelte</a> is. Svelte is a UI framework with a bold new idea: rather than providing a library that you write code with (like React or Vue, for example), it's a compiler that turns your components into highly optimized vanilla JavaScript. If you haven't already read the <a href='https://svelte.technology/blog/frameworks-without-the-framework'>introductory blog blog</a>, you should!</p>
...
blogs.forEach(blog => {
  blog.html = blog.html.replace(/^\t{3}/gm, '')
})
